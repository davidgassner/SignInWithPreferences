...
public class SampleDataProvider {
    ...
    public static Map<String, DataItem> menuItemMap;

    static {
        dataItemList = new ArrayList<>();
        menuItemMap = new HashMap<>();

        addMenuItem(new DataItem(null, "Quinoa Salmon Salad", "Salads",
        ...
        addMenuItem(new DataItem(null, "Chef's Salad", "Salads",
        ...
        addMenuItem(new DataItem(null, "House Salad", "Salads",
        ...
        addMenuItem(new DataItem(null, "Garden Buffet", "Salads",
                "Choose from our fresh local, organically grown ingredients to make a custom salad.",
                4, 10, ""));

        addMenuItem(new DataItem(null, "Mini Cheeseburgers", "Starters",
        ...
        addMenuItem(new DataItem(null, "Panko Stuffed Mushrooms", "Starters",
        ...
        addMenuItem(new DataItem(null, "French Onion Soup", "Starters",
        ...
        addMenuItem(new DataItem(null, "Artichokes with Garlic Aeoli", "Starters",
        ...
        addMenuItem(new DataItem(null, "Parmesan Deviled Eggs", "Starters",
                "SOME SAY OUR EGGS ARE DEVILISHLY GOOD. I HAVE TO AGREE.\n" +
                        "These delectable little bites are made with organic eggs, fresh Parmesan, and chopped pine nuts.\"",
                5, 8, "deviled_eggs.jpg"));

        addMenuItem(new DataItem(null, "Classic Burger", "Entrees",
        ...
        addMenuItem(new DataItem(null, "Tomato Bruschetta Tortellini", "Entrees",
        ...
        addMenuItem(new DataItem(null, "Handcrafted Pizza", "Entrees",
        ...
        addMenuItem(new DataItem(null, "Barbecued Tofu Skewers", "Entrees",
        ...
        addMenuItem(new DataItem(null, "Fiesta Family Platter", "Entrees",
        ...
        addMenuItem(new DataItem(null, "Crème Brûlée", "Desserts",
    ...
    private static void addMenuItem(DataItem dataItem) {
        dataItemList.add(dataItem);
        menuItemMap.put(dataItem.getItemId(), dataItem);
    }
